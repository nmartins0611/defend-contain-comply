...
In this 120–150 minute workshop you will manage a complete vulnerability lifecycle on a RHEL system using AAP:
...
* **Module 3 — COMPLY**: Containerize the hardened application for immutable deployment
